...
//            mer.hum = 0;
    ...
    */
    ...
    private Instant parseDateTime(String line){
        ...
        // Boolean res = date.matches("^(19|20)\\d\\d[- /.](0[1-9]|1[012])[- /.](0[1-9]|[12][0-9]|3[01])$");
        // Boolean res = date.matches("^\\d{4}/\\d{2}/\\d{2}$");
        Pattern p = Pattern.compile("\\d{4}/\\d{2}/\\d{2},\\d{2}:\\d{2}:\\d{2}\\+\\d{2}");
